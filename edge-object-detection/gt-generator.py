...
class YoloDataGenerator():
    ...
    def ClassifyEdge(self, p_1, p_2) -> int:
        ...
        if YoloDataGenerator.PixelCompare(p_1[1], p_2[1]):
            ...
            return 3
        elif (p_1[0] - p_2[0]) * (p_1[1] - p_2[1]) > 0:
            return 0
        else:
            return 1
    ...
    def GenerateSample(self, base_name, directory_path, training):
        ...
        edge_center = YoloDataGenerator.CalculateCenter((x_1, y_1), (x_2, y_2))
        txt_file.write(f'{edge_class}\t{edge_center[0]}\t{edge_center[1]}\t{x_2}\t{y_2}\n')
